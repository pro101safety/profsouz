...
public class OfficialInfoFragment extends Fragment {
    private static final String OFFICIAL_INFO_URL = "https://fpb.1prof.by/oficialnaya-informaciya/";
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.webviewContent.loadUrl(OFFICIAL_INFO_URL);
    }
