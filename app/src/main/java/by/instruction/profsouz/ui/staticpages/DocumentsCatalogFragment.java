...
public class DocumentsCatalogFragment extends Fragment {
    private static final String CATALOG_URL = "https://fpb.1prof.by/katalog-dokumentov/";
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.webviewContent.loadUrl(CATALOG_URL);
    }
